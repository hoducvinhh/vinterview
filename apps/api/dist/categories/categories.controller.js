...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all categories with question counts' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get category detail by ID or Slug' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Category detail' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create new category (Admin Only)' }),
