...
__decorate([
    ...
    (0, swagger_1.ApiConflictResponse)({ description: 'Email address already registered.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Authenticate user and return JWT access token' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'User logged in successfully.' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Invalid email or password credentials.' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Authenticate or register user via Google OAuth ID Token' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Google login successful.' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Invalid Google ID token.' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Missing or invalid Bearer JWT token.' }),
