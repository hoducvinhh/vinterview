...
import { JsonLd, getCollectionPageJsonLd, getBreadcrumbJsonLd } from '@/components/seo/JsonLd';
...
export default async function QuestionsPage({ searchParams }: PageProps) {
  ...
  const collectionJsonLd = getCollectionPageJsonLd(siteUrl);
  const breadcrumbJsonLd = getBreadcrumbJsonLd([
    { name: 'Trang chủ', url: siteUrl },
    { name: 'Ngân hàng câu hỏi', url: `${siteUrl}/questions` },
  ]);
